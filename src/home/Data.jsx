...
const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__title">Pradeepsinh Chavda
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I'm an full-stack developer, passionate about building my vision of the digital world from the ground up. From design to deployment, I tackle real-world problems with creativity and purpose, constantly striving to innovate and learn.</p>
