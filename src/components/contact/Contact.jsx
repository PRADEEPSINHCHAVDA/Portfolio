            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <a href="mailto:pradeepsinh.aws@gmail.com" className="contact__button">Write me <i className="bx bx-right-arrow-alt
                    ...
                    <i className="bx bxl-whatsapp contact__card-icon"></i>
                     ...
                     <div className="contact__card">
                        ...
                        <a href="https://www.linkedin.com/in/pradeepsinh-chavda-008ba1161/" className="contact__button">Write me <i className="bx bx-right-arrow-alt
                        contact__button-icon"></i></a>
